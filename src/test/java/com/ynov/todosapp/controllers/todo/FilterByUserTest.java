...
public class FilterByUserTest extends TodoControllerTest {
    ...
    void testFilterByUser() {
        ResponseEntity<TodosPaginedDTO> response = controller.retrieveTodos(0, 10, "", "", "createdDate", "desc", 99L, null);
    ...
    void testFilterByNoUser() {
        ResponseEntity<TodosPaginedDTO> response = controller.retrieveTodos(0, 10, "", "", "createdDate", "desc", null, false);
    ...
    void testFilterByUserEmptyList() {
        ResponseEntity<TodosPaginedDTO> response = controller.retrieveTodos(0, 10, "", "", "createdDate", "desc", 101L, null);
    ...
    void testFilterByUserInvalidUser() {
        ResponseEntity<TodosPaginedDTO> response = controller.retrieveTodos(0, 10, "", "", "createdDate", "desc", 200L, null);
    ...
    void testFilterByUserWithOtherFilters() {
        ResponseEntity<TodosPaginedDTO> response = controller.retrieveTodos(0, 10, "", "todo", "createdDate", "desc", 99L, null);
        ...
        response = controller.retrieveTodos(0, 10, "tata", "", "createdDate", "desc", 100L, null);
