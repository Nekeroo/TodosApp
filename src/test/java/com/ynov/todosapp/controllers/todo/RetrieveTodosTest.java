...
public class RetrieveTodosTest extends TodoControllerTest {
    ...
    void testBodyContent() {
        final ResponseEntity<?> response = controller.retrieveTodos(1, 10, "", "", "createdDate", "", null, null, null);
    ...
    @Test
    void testPagination() {
        final ResponseEntity<?> response = controller.retrieveTodos(2, 10, "", "", "createdDate", "", null, null, null);
        final TodosPaginedDTO todos = (TodosPaginedDTO) response.getBody();
    ...
    @Test
    void testEmptyPage() {
        final ResponseEntity<?> response = controller.retrieveTodos(3, 10, "", "", "createdDate", "", null, null, null);
        final TodosPaginedDTO todos = (TodosPaginedDTO) response.getBody();
    ...
    void testInvalidPageSize() {
        assertThrows(InvalidPageSize.class, () -> controller.retrieveTodos(1, 0, "", "", "createdDate", "", null, null, null));
    }
